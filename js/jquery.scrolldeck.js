			...
			for (i=0; i<$('.animate-in').length; i++) {
				...
				switch (anim.attr('data-animation')) {
					case 'fly-in-left':
						...
						scrolldeck.controller.animate(anim, { delay: windowHeight/2, duration: windowHeight/4, property:'left', start:-400 });
						break;
					case 'fly-in-right':
						anim
							.parent().css('overflow','hidden');
					...
					case 'space-in':
						...
						break;
					case 'fade-in':
						scrolldeck.controller.animate(anim, { delay: windowHeight/3, duration: windowHeight/1.5, property:'opacity', start:0 });
						break;
					default:
